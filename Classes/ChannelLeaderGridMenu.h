...
@class ChannelLeaderGridMenu;

@interface ChannelLeaderGrideMenuItem : NSObject
...
@optional
- (void)gridMenu:(ChannelLeaderGridMenu *)gridMenu willDismissWithSelectedItem:(ChannelLeaderGrideMenuItem *)item atIndex:(NSInteger)itemIndex;
- (void)gridMenuWillDismiss:(ChannelLeaderGridMenu *)gridMenu;
@end


@interface ChannelLeaderGridMenu : UIViewController
